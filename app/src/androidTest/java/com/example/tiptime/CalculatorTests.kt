...
class CalculatorTests {
    ...
    fun calculate_20_no_round() {
        ...
        onView(withId(R.id.calculate_button))
            .perform(click())
        onView(withId(R.id.tip_result))
            .check(matches(withText(containsString("19.80"))))
    }
    ...
    fun calculate_18_no_round() {
        ...
        onView(withId(R.id.calculate_button))
            .perform(click())
        onView(withId(R.id.tip_result))
            .check(matches(withText(containsString("17.82"))))
    }
    ...
    fun calculate_15_no_round() {
        ...
        onView(withId(R.id.calculate_button))
            .perform(click())
        onView(withId(R.id.tip_result))
            .check(matches(withText(containsString("14.85"))))
    }
    ...
    fun calculate_18_large_number() {
        ...
        onView(withId(R.id.calculate_button))
            .perform(click())
        onView(withId(R.id.tip_result))
            .check(matches(withText(containsString("17,999.84"))))
    }
}